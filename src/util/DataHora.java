...
//        }
        ...
        //Exemplo manipulação de data
        LocalDate hoje = LocalDate.now(); // Obtém a data atual
        LocalDate dataEspeficada = LocalDate.of(2023, 8, 8); // Cria uma data específica
        LocalDate dataFutura = hoje.plusDays(10); // Adciona 10 dias à data atual
        System.out.println("Data de hoje: " + hoje);
        System.out.println("Data especifica " + dataEspeficada);
        System.out.println("Data futura " + dataFutura);

        //Exemplo de manipulação de hora
        LocalTime agora = LocalTime.now(); // Obtém hora atual
        LocalTime horaEspecifica = LocalTime.of(14,30); // Cria uma hora especifica
        LocalTime horaFurura = agora.plusHours(2); //Adiciona 2 horas à hora atual
        System.out.println("Hora atual: " + agora);
        System.out.println("Hora específica: " + horaEspecifica);
        System.out.println("Hora futura: " + horaFurura);
