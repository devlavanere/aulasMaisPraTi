...
// Cria uma classe pública chamada SimpleQueue.
public class SimpleQueue {
    // Declara dois atributos privados ambos do tipo Node.
    private Node first;
    private Node last;
    ...
    // Cria uma classe estática interna chamada Node, usada para criar os nós da fila
    private static class Node {
        int data; // Atributo que armazena o valor do nó.
        Node next; // Atributo que referencia o próximo nó da fila

        // Construtor da classe Node que recebe um valor e armazena em data.
        // E inicializa next como null.
    ...
    // Método para adicionar um novo elemento a fila(enfileirar)
    ...
    public int dequeue() {
        ...
        if(this.first == null) {
            // Se fila estiver vazia, lança uma exceção.
            throw new IllegalStateException("Fila vazia!");
        }

        // Armazena o valor do primeiro nó para retorno.
        int data = this.first.data;
        // Atualiza first para o próximo nó da fila.
